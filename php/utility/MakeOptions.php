...
// ForexTrading SDK utility: make_options

class ForexTradingMakeOptions
{
    ...
    public static function call(ForexTradingContext $ctx): array
    {
        ...
        //
        // `ForexTradingSchema::optspec()` is built from the model:
        ...
        $optspec = ForexTradingSchema::optspec();
