...
// instead of `sdk.NewForexTradingSDK(nil)` / `sdk.TestSDK(nil, nil)`
// for the common no-options case.
func New() *ForexTradingSDK  { return NewForexTradingSDK(nil) }
func Test() *ForexTradingSDK { return TestSDK(nil, nil) }
