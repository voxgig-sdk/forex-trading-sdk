...
function envOverride(m) {
    if ('TRUE' === process.env.FOREX_TRADING_TEST_LIVE ||
        'TRUE' === process.env.FOREX_TRADING_TEST_OVERRIDE) {
    ...
    m.FOREX_TRADING_TEST_EXPLAIN = process.env.FOREX_TRADING_TEST_EXPLAIN || m.FOREX_TRADING_TEST_EXPLAIN;
    return m;
}
