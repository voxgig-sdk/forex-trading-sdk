...
from forextrading_sdk.utility import register

# Load features
from forextrading_sdk.feature.base_feature import ForexTradingBaseFeature
from forextrading_sdk.features import _has_feature, _make_feature
...
class ForexTradingSDK:
    ...
    def get_utility(self):
        return ForexTradingUtility.copy(self._utility)
    ...
    def graphql(self, query, variables=None, ctrl=None):
        ...
        if isinstance(errors, list) and 0 < len(errors):
            ...
            res["ok"] = False
            res["err"] = Exception("ForexTradingSDK: graphql: " + str(msg))
            res["graphql"] = errors
    ...
    def MarketData(self, data=None) -> "MarketDataEntity":
        ...
        from forextrading_sdk.entity.market_data_entity import MarketDataEntity
        return MarketDataEntity(self, data)



    @classmethod
    def test(cls, testopts=None, sdkopts=None) -> "ForexTradingSDK":
        if sdkopts is None:
            sdkopts = {}
