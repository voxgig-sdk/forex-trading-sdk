...
function runner.env_override(m)
  local live = runner.getenv("FOREXTRADING_TEST_LIVE")
  local override = runner.getenv("FOREXTRADING_TEST_OVERRIDE")
  ...
  local explain = runner.getenv("FOREXTRADING_TEST_EXPLAIN")
