...
// ForexTrading SDK utility: fetcher

class ForexTradingFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; ForexTradingSDK/1.0)';
    ...
    public static function call(ForexTradingContext $ctx, string $fullurl, array $fetchdef): array
    {
