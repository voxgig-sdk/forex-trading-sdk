...
The PHP SDK for the ForexTrading API. Provides an entity-oriented interface using PHP conventions.
...
```php
[$result, $err] = $client->MarketData(null)->list(null, null);
...
[$result, $err] = $client->ForexTrading(null)->load(
    ["id" => "test01"], null
);
