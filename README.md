...
| --- | --- | --- |
| TypeScript | `@voxgig-sdk/forex-trading` | `npm install @voxgig-sdk/forex-trading` |
| Python | `voxgig-sdk-forex-trading` | `pip install voxgig-sdk-forex-trading` |
| PHP | `voxgig-sdk/forex-trading` | `composer require voxgig-sdk/forex-trading` |
| Golang | `github.com/voxgig-sdk/forex-trading-sdk/go` | `go get github.com/voxgig-sdk/forex-trading-sdk/go` |
| Ruby | `voxgig-sdk-forex-trading` | `gem install voxgig-sdk-forex-trading` |
| Lua | `voxgig-sdk-forex-trading` | `luarocks install voxgig-sdk-forex-trading` |
