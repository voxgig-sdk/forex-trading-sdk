...
// ForexTrading SDK pipeline test
//
...
{
    private static function utility(): ForexTradingUtility
    {
        return new ForexTradingUtility();
    }
    ...
    private static function ctx(array $over = []): ForexTradingContext
    {
        $utility = $over['utility'] ?? self::utility();
        $client = $over['client'] ?? new PlClient(['base' => 'http://h']);
        $ctx = new ForexTradingContext([
            'client' => $client,
            'utility' => $utility,
        ], null);
        $ctx->op = new ForexTradingOperation(['name' => 'load', 'entity' => 'x']);
        foreach ($over as $k => $v) {
    ...
    {
        return ($err instanceof ForexTradingError) ? $err->sdk_code : '';
    }
    ...
    public function test_make_point_rejects_a_disallowed_operation(): void
    {
        ...
        $ctx->op = new ForexTradingOperation(['name' => 'nope', 'entity' => 'x']);
        [$point, $err] = ForexTradingMakePoint::call($ctx);
    ...
    public function test_make_point_rejects_an_operation_with_no_endpoints(): void
    {
        ...
        $ctx->op = new ForexTradingOperation(['name' => 'load', 'entity' => 'x', 'points' => []]);
        [$point, $err] = ForexTradingMakePoint::call($ctx);
        $this->assertNull($point);
    ...
    public function test_make_point_returns_the_single_point(): void
    {
        ...
        $ctx = self::ctx(['options' => ['allow' => ['op' => 'load,list,create,update,remove']]]);
        $ctx->op = new ForexTradingOperation(['name' => 'load', 'entity' => 'x', 'points' => [$point]]);
        [$got, $err] = ForexTradingMakePoint::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new ForexTradingSpec(['method' => 'GET']);
        $ctx = self::ctx();
        $ctx->out['spec'] = $preset;
        [$got, $err] = ForexTradingMakeSpec::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_response_guards_missing_spec_response_result(): void
    {
        $ctx = self::ctx([
            'spec' => null,
            'response' => new ForexTradingResponse([]),
            'result' => new ForexTradingResult([]),
        ]);
        [, $err] = ForexTradingMakeResponse::call($ctx);
        $this->assertSame('response_no_spec', self::code($err));

        $ctx = self::ctx([
            'spec' => new ForexTradingSpec([]),
            'response' => null,
            'result' => new ForexTradingResult([]),
        ]);
        [, $err] = ForexTradingMakeResponse::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'spec' => new ForexTradingSpec(['step' => 's']),
            'response' => new ForexTradingResponse(self::resp(404, null, ['x-a' => '1'])),
            'result' => new ForexTradingResult([]),
        ]);
        [, $err] = ForexTradingMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_2xx_parses_the_body_and_marks_ok(): void
    {
        $ctx = self::ctx([
            'spec' => new ForexTradingSpec(['step' => 's']),
            'response' => new ForexTradingResponse(self::resp(200, ['v' => 1])),
            'result' => new ForexTradingResult([]),
        ]);
        [, $err] = ForexTradingMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_records_to_ctrl_explain_when_explain_is_on(): void
    {
        $ctx = self::ctx([
            'spec' => new ForexTradingSpec(['step' => 's']),
            'response' => new ForexTradingResponse(self::resp(200, ['v' => 2])),
            'result' => new ForexTradingResult([]),
        ]);
        $ctx->ctrl->explain = ['on' => true];
        ForexTradingMakeResponse::call($ctx);
    ...
    {
        $preset = new ForexTradingResponse(self::resp(299));
        $ctx = self::ctx([
            'spec' => new ForexTradingSpec([]),
            'response' => new ForexTradingResponse([]),
            'result' => new ForexTradingResult([]),
        ...
        [$got, $err] = ForexTradingMakeResponse::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null, 'result' => new ForexTradingResult([])]);
        [, $err] = ForexTradingMakeResult::call($ctx);
        $this->assertSame('result_no_spec', self::code($err));

        $ctx = self::ctx(['spec' => new ForexTradingSpec([]), 'result' => null]);
        [, $err] = ForexTradingMakeResult::call($ctx);
    ...
    public function test_make_result_list_op_wraps_resdata_into_entity_instances(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new ForexTradingSpec(['step' => 's']),
            'result' => new ForexTradingResult(['ok' => true, 'resdata' => [['a' => 1], ['a' => 2]]]),
        ]);
        $ctx->op = new ForexTradingOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = ForexTradingMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_result_empty_list_yields_empty_resdata(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new ForexTradingSpec(['step' => 's']),
            'result' => new ForexTradingResult(['ok' => true, 'resdata' => []]),
        ]);
        $ctx->op = new ForexTradingOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = ForexTradingMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new ForexTradingResult(['ok' => true]);
        $ctx = self::ctx([
            'spec' => new ForexTradingSpec([]),
            'result' => new ForexTradingResult([]),
        ]);
        $ctx->out['result'] = $preset;
        [$got, $err] = ForexTradingMakeResult::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_request_guards_a_missing_spec(): void
    {
        ...
        [, $err] = ForexTradingMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $boom = new ForexTradingError('boom', 'boom');
        $utility->fetcher = function (ForexTradingContext $_c, string $_u, array $_f) use ($boom): array {
            return [null, $boom];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new ForexTradingSpec(['step' => 's', 'method' => 'GET', 'base' => 'http://h', 'parts' => ['a']]),
        ]);
        [$response, $err] = ForexTradingMakeRequest::call($ctx);
        $this->assertNull($err);
    ...
    {
        $utility = self::utility();
        $utility->fetcher = function (ForexTradingContext $_c, string $_u, array $_f): array {
            return [null, null];
        };
        $ctx = self::ctx([
            'utility' => $utility,
    ...
    public function test_make_request_a_normal_transport_response_is_wrapped(): void
    {
        ...
        [$response, $err] = ForexTradingMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertInstanceOf(ForexTradingResponse::class, $response);
    ...
    public function test_make_request_records_the_fetchdef_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->explain = ['on' => true];
        ForexTradingMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $utility->make_fetch_def = function (ForexTradingContext $c): array {
            return [null, $c->make_error('fetchdef_boom', 'boom')];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new ForexTradingSpec(['step' => 's', 'method' => 'GET']),
        ]);
        [$response, $err] = ForexTradingMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertNotNull($response->err);
    ...
    {
        $preset = new ForexTradingResponse(self::resp(201));
        $ctx = self::ctx(['spec' => new ForexTradingSpec([])]);
        $ctx->out['request'] = $preset;
        [$got, $err] = ForexTradingMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null]);
        [, $err] = ForexTradingMakeFetchDef::call($ctx);
    ...
    public function test_make_fetch_def_serialises_body_and_inits_missing_result(): void
    {
        ...
        [$fetchdef, $err] = ForexTradingMakeFetchDef::call($ctx);
        $this->assertNull($err);
    ...
    {
        $ctx = self::ctx(['result' => new ForexTradingResult(['ok' => true, 'resdata' => 42])]);
        $this->assertSame(42, ForexTradingDone::call($ctx));
    }

    public function test_done_raises_the_error_when_not_ok(): void
    {
        $ctx = self::ctx(['result' => new ForexTradingResult(['ok' => false])]);
        $this->expectException(ForexTradingError::class);
        ForexTradingDone::call($ctx);
    }

    public function test_make_error_returns_resdata_when_ctrl_throw_is_false(): void
    {
        $ctx = self::ctx(['result' => new ForexTradingResult(['ok' => false, 'resdata' => 'fallback'])]);
        $ctx->ctrl->throw_err = false;
        $this->assertSame('fallback', ForexTradingMakeError::call($ctx, null));
    }
    ...
    public function test_make_error_records_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->throw_err = false;
        $ctx->ctrl->explain = ['on' => true];
        ForexTradingMakeError::call($ctx, null);
    ...
    public function test_feature_add_appends_in_call_order(): void
    {
        ...
        $a = new ForexTradingBaseFeature();
        $b = new ForexTradingBaseFeature();
        ForexTradingFeatureAdd::call($ctx, $a);
        ForexTradingFeatureAdd::call($ctx, $b);
        $this->assertSame([$a, $b], $client->features);
    }

    private static function named_feature(string $name): ForexTradingBaseFeature
    {
        $f = new ForexTradingBaseFeature();
        $f->name = $name;
        return $f;
    }
    ...
    public function test_feature_add_ordering_before_after_replace(): void
    {
        ...
        ForexTradingFeatureAdd::call($ctx, $miss);
    ...
    private static function auth_ctx(array $options, ?array $headers): ForexTradingContext
    {
        $client = new PlClient($options);
        return self::ctx([
            'client' => $client,
            'spec' => $headers === null ? null : new ForexTradingSpec(['headers' => $headers]),
        ]);
    }
    ...
    public function test_prepare_auth_guards_a_missing_spec(): void
    {
        ...
        [, $err] = ForexTradingPrepareAuth::call($ctx);
    ...
    public function test_prepare_auth_a_raw_apikey_goes_in_as_is(): void
    {
        ...
        ForexTradingPrepareAuth::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'response' => new ForexTradingResponse(['headers' => null]),
            'result' => new ForexTradingResult([]),
        ]);
        ForexTradingResultHeaders::call($ctx);
    ...
    public function test_result_body_skips_parsing_when_the_body_is_absent(): void
    {
        ...
        ForexTradingResultBody::call($ctx);
