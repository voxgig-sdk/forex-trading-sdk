...
// ForexTrading SDK cache feature
...
class ForexTradingCacheFeature extends ForexTradingBaseFeature
{
    ...
    private function _through(ForexTradingContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
