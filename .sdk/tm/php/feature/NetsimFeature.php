...
// ForexTrading SDK netsim feature
...
class ForexTradingNetsimFeature extends ForexTradingBaseFeature
{
    ...
    private function _simulate(ForexTradingContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
        $this->calls++;
        $call = $this->calls;
    ...
    private function _track(ForexTradingContext $ctx, array $applied): void
    {
        $client = $this->client;
