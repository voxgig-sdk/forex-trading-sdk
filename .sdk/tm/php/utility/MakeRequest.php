...
// ForexTrading SDK utility: make_request

require_once __DIR__ . '/../core/Response.php';
require_once __DIR__ . '/../core/Result.php';

class ForexTradingMakeRequest
{
    public static function call(ForexTradingContext $ctx): array
    {
        ...
        if ($fetch_err) {
            ...
            $response = new ForexTradingResponse(['err' => $ctx->make_error('request_no_response', 'response: undefined')]);
        } elseif (is_array($fetched)) {
            $response = new ForexTradingResponse($fetched);
        } else {
