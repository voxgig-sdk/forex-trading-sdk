...
(0, node_test_1.describe)('MarketDataDirect', async () => {
    ...
    (0, node_test_1.test)('direct-exists', async () => {
        const sdk = new __1.ForexTradingSDK({
...
function liveScenariosActive() { return false && process.env.FOREX_TRADING_TEST_LIVE === 'TRUE'; }
function directSetup(mockres) {
    ...
    if (live) {
        ...
        const client = new __1.ForexTradingSDK(Object.assign({}, (0, utility_1.liveClientOptions)(), { system: { fetch: transport.fetch },
            apikey: env.FOREX_TRADING_APIKEY,
        }));
        let idmap = env['FOREX_TRADING_TEST_MARKET_DATA_ENTID'];
    ...
    const client = new __1.ForexTradingSDK({
        base: 'http://localhost:8080',
