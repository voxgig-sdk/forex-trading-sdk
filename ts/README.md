# ForexTrading TypeScript SDK



The TypeScript SDK for the ForexTrading API — a type-safe, entity-oriented client with full async/await support.

The API is exposed as capitalised, semantic **Entities** — e.g.
`client.MarketData()` — each with a small set of operations (`list`)
...
| `tester(testopts?, sdkopts?)` | `ForexTradingSDK` | Create a test-mode client instance. |

#### Static methods

| Method | Returns | Description |
| --- | --- | --- |
| `ForexTradingSDK.test(testopts?, sdkopts?)` | `ForexTradingSDK` | Create a test-mode client. |
...
| `client` | `client(): ForexTradingSDK` | Return the parent SDK client. |
...
forex-trading/
├── src/
│   ├── ForexTradingSDK.ts        # Main SDK class
