...
function envOverride(m: Record<string, any>) {
  if (
    'TRUE' === process.env.FOREXTRADING_TEST_LIVE ||
    'TRUE' === process.env.FOREXTRADING_TEST_OVERRIDE
  ) {
  ...
  m.FOREXTRADING_TEST_EXPLAIN = process.env.FOREXTRADING_TEST_EXPLAIN || m.FOREXTRADING_TEST_EXPLAIN
