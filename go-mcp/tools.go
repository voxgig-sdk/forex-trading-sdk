...
func registerTools(server *mcp.Server, client *sdk.ForexTradingSDK) {
	mcp.AddTool(server, &mcp.Tool{
		Name: "forex-trading_list",
		Description: "List records from ForexTrading. " +
	...
	mcp.AddTool(server, &mcp.Tool{
		Name: "forex-trading_load",
		Description: "Load a single record from ForexTrading. " +
...
func runOp(client *sdk.ForexTradingSDK, op string, args Args) (*mcp.CallToolResult, any, error) {
...
func entityFor(client *sdk.ForexTradingSDK, name string) (sdk.ForexTradingEntity, error) {
