...
// ForexTrading SDK idempotency feature
...
class ForexTradingIdempotencyFeature extends ForexTradingBaseFeature
{
    ...
    private function _mutating(ForexTradingContext $ctx): bool
    {
