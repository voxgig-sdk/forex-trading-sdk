...
class ForexTradingTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = ForexTradingTestRunner.getenv("FOREXTRADING_TEST_LIVE")
        override = ForexTradingTestRunner.getenv("FOREXTRADING_TEST_OVERRIDE")
        ...
        explain = ForexTradingTestRunner.getenv("FOREXTRADING_TEST_EXPLAIN")
