# ForexTrading Ruby SDK



The Ruby SDK for the ForexTrading API — an entity-oriented client using idiomatic Ruby conventions.
...
raise a `ForexTradingError` (a `StandardError` subclass), so wrap
...
```
rb/
├── ForexTrading_sdk.rb       -- Main SDK module
...
The main module (`ForexTrading_sdk`) exports the SDK class
