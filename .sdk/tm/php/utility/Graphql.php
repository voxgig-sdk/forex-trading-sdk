...
// ForexTrading SDK utility: graphql
//
...
class ForexTradingGraphql
{
    ...
    // equivalent.
    public static function body(ForexTradingContext $ctx): mixed
    {
    ...
    public static function errors(ForexTradingContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
