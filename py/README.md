...
The Python SDK for the ForexTrading API — an entity-oriented client following Pythonic conventions.
...
release tag (`py/vX.Y.Z`, see [Releases](https://github.com/voxgig-sdk/forex-trading-sdk/releases)) or
