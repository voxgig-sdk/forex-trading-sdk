...
// ForexTrading SDK utility type

class ForexTradingUtility
{
    ...
    public static function copy(ForexTradingUtility $src): ForexTradingUtility
    {
        $u = new ForexTradingUtility();
        $u->clean = $src->clean;
        $u->done = $src->done;
