...
// ForexTrading SDK struct utility test
//
...
class StructUtilityTest extends TestCase
{
    ...
    {
        if (self::$run === null) {
            $runner = ForexTradingOmni::makeStructRunner(
        ...
        $this->runsection(
            ...
            function ($input) {
                ...
                if (is_object($store) && $haspath && Struct::undef() !== $val) {
                    ...
                    if (json_encode(ForexTradingOmni::structfix($now, Struct::undef()))
                        !== json_encode(ForexTradingOmni::structfix($val, Struct::undef()))) {
