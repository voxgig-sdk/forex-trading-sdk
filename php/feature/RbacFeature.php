...
class ForexTradingRbacFeature extends ForexTradingBaseFeature
{
    ...
    private function _required(ForexTradingContext $ctx): ?string
    {
    ...
    private function _reject(ForexTradingContext $ctx, string $required): void
    {
    ...
    private function _track(ForexTradingContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
