...
// ForexTrading SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (ForexTradingSDK::test)
...
{
    private const SDK_CLASS = 'ForexTradingSDK';
    ...
    private const SDK_BASE = 'forextrading_sdk';
    ...
    public function test_php_examples_run_offline(): void
    {
        $ran = 0;
        $failures = [];
        $sdk = __DIR__ . '/../forextrading_sdk.php';
        foreach ($this->phpBlocks() as $blk) {
