...
#      offline in seeded test mode (ForexTradingSDK.test) against the real
...
class ReadmeExamplesTest < Minitest::Test
  ...
  SDK = File.join(__dir__, "..", "ForexTrading_sdk.rb")
  SDK_CLASS = "ForexTradingSDK"
