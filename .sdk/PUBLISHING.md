...
|---|---|---|
| `ts/` | @voxgig-sdk/forex-trading-sdk | `.github/workflows/publish-ts.yml` |
...
required):
    ...
    npm trust github @voxgig-sdk/forex-trading-sdk \
      --repository voxgig-sdk/forex-trading-sdk \
      --file publish-ts.yml \
      --allow-publish

Then `npm trust list @voxgig-sdk/forex-trading-sdk` shows it, and
`npm trust revoke @voxgig-sdk/forex-trading-sdk --id=<id>` removes it.
