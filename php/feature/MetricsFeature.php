...
// ForexTrading SDK metrics feature
...
class ForexTradingMetricsFeature extends ForexTradingBaseFeature
{
    ...
    private function _record(ForexTradingContext $ctx, bool $ok): void
    {
