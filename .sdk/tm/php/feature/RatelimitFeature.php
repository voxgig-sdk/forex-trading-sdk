...
// ForexTrading SDK ratelimit feature
...
class ForexTradingRatelimitFeature extends ForexTradingBaseFeature
{
    ...
    private function _acquire(ForexTradingContext $ctx): void
    {
    ...
    private function _track(ForexTradingContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
