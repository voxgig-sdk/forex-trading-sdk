...
from projectname_sdk.core.control import ForexTradingControl
...
class ForexTradingContext:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        if isinstance(sp, ForexTradingSpec):
            self.spec = sp
        elif basectx is not None:
        ...
        if isinstance(r, ForexTradingResult):
            self.result = r
        elif basectx is not None:
        ...
        if isinstance(rp, ForexTradingResponse):
            self.response = rp
        elif basectx is not None:
    ...
    def make_error(self, code, msg):
        return ForexTradingError(code, msg, self)
