...
// ForexTrading SDK proxy feature
...
class ForexTradingProxyFeature extends ForexTradingBaseFeature
{
    ...
    public function init(ForexTradingContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (ForexTradingContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
