...
// ForexTrading SDK timeout feature
...
class ForexTradingTimeoutFeature extends ForexTradingBaseFeature
{
    ...
    private function _with_timeout(ForexTradingContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(ForexTradingContext $_ctx, float $ms): void
    {
        $client = $this->client;
