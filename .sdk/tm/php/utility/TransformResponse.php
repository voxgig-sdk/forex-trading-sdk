...
// ForexTrading SDK utility: transform_response

require_once __DIR__ . '/../core/Helpers.php';

class ForexTradingTransformResponse
{
    public static function call(ForexTradingContext $ctx): mixed
    {
        ...
        $transform = ForexTradingHelpers::to_map(\Voxgig\Struct\Struct::getprop($point, 'transform'));
        if (!$transform) {
            return null;
        }
