...
function runner.env_override(m)
  local live = runner.getenv("FOREX_TRADING_TEST_LIVE")
  local override = runner.getenv("FOREX_TRADING_TEST_OVERRIDE")
  ...
  local explain = runner.getenv("FOREX_TRADING_TEST_EXPLAIN")
