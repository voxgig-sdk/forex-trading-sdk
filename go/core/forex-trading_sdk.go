...
func (sdk *ForexTradingSDK) OptionsMap() map[string]any {
...
func (sdk *ForexTradingSDK) GetUtility() *Utility {
	return CopyUtility(sdk.utility)
}

func (sdk *ForexTradingSDK) GetRootCtx() *Context {
	return sdk.rootctx
}

func (sdk *ForexTradingSDK) Prepare(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *ForexTradingSDK) Direct(fetchargs map[string]any) (map[string]any, error) {
...
func (sdk *ForexTradingSDK) opAllowed(op string) bool {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return strings.Contains(allowOp, op)
}

func (sdk *ForexTradingSDK) opDenied(op string) map[string]any {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return map[string]any{
		"ok": false,
		"err": fmt.Errorf("ForexTradingSDK: %s: operation not allowed by"+
...
// gate by passing it.
func (sdk *ForexTradingSDK) rawRequest(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *ForexTradingSDK) Graphql(
	...
	if 0 < len(errors) {
		...
		res["ok"] = false
		res["err"] = fmt.Errorf("ForexTradingSDK: graphql: %s", msg)
		res["graphql"] = errors
	}
...
func TestSDK(testopts map[string]any, sdkopts map[string]any) *ForexTradingSDK {
	...
	sdk := NewForexTradingSDK(sdkopts)
	sdk.Mode = "test"
