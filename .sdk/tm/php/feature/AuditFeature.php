...
// ForexTrading SDK audit feature
...
class ForexTradingAuditFeature extends ForexTradingBaseFeature
{
    ...
    private function _emit(ForexTradingContext $ctx, string $outcome): void
    {
