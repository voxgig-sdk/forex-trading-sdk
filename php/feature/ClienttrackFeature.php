...
// ForexTrading SDK clienttrack feature
...
class ForexTradingClienttrackFeature extends ForexTradingBaseFeature
{
    ...
    public function PostConstruct(ForexTradingContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'ForexTrading-SDK';
