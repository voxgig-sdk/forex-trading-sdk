...
func registerSDKWords(r *eng.Registry, client *sdk.ForexTradingSDK) {
...
func runOp(client *sdk.ForexTradingSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
