// Command ForexTrading-mcp is an MCP server exposing the ForexTrading
// SDK as MCP tools.
//
// Two tools are registered:
//
//	ForexTrading_list  — list records of an entity
//	ForexTrading_load  — load a single record of an entity
//
