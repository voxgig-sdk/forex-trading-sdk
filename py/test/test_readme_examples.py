# ForexTrading SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions ForexTradingSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both ForexTradingSDK(...) and ForexTradingSDK.test(...) become
#      ForexTradingSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "forextrading_sdk"
_SDK_CLASS = "ForexTradingSDK"
