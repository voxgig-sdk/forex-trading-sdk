...
// ForexTrading SDK streaming feature
...
class ForexTradingStreamingFeature extends ForexTradingBaseFeature
{
    ...
    private function _iterate(ForexTradingResult $result): \Generator
    {
    ...
    private function _streamable(ForexTradingContext $ctx): bool
    {
